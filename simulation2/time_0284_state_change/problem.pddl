(define (problem simulation-a)
	...
	(:init
		...
		(tv-playing-channel mark-bedroom-tv cartoon-network)
		...
		(shelf-contains linda-bedroom-shelf fork level-6)
		...
		(table-contains linda-bedroom-table black-pen)
		(shelf-contains mark-bedroom-shelf tom-sawyer-book level-6)
		(shelf-contains living-room-shelf plate level-3)
		(shelf-contains mark-bedroom-shelf spoon level-8)
		(table-contains linda-bedroom-table lord-of-the-rings-book)
		(shelf-contains mark-bedroom-shelf blue-pen level-3)
	)
)
