(define (problem simulation-a)
	...
	(:init
		...
		(tv-playing-channel mark-bedroom-tv fox-news)
		...
		(tv-playing-channel linda-bedroom-tv nbc)
		...
		(shelf-contains mark-bedroom-shelf knife level-3)
		(shelf-contains mark-bedroom-shelf purple-pen level-9)
