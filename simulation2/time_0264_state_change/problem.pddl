(define (problem simulation-a)
	...
	(:init
		...
		(shelf-contains living-room-shelf fork level-1)
		...
		(shelf-contains mark-bedroom-shelf orange level-7)
		(shelf-contains mark-bedroom-shelf knife level-1)
		(table-contains living-room-table purple-pen)
		(table-contains linda-bedroom-table black-pen)
		(shelf-contains mark-bedroom-shelf tom-sawyer-book level-9)
