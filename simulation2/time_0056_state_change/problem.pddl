(define (problem simulation-a)
	...
	(:init
		...
		(shelf-contains living-room-shelf apple level-3)
		(table-contains mark-bedroom-table orange)
		(shelf-contains linda-bedroom-shelf knife level-10)
		(shelf-contains mark-bedroom-shelf purple-pen level-2)
		(table-contains living-room-table black-pen)
		(table-contains mark-bedroom-table tom-sawyer-book)
		(sink-contains kitchen-sink plate)
		(sink-contains kitchen-sink spoon)
		(shelf-contains living-room-shelf lord-of-the-rings-book level-3)
