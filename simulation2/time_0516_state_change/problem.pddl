(define (problem simulation-a)
	...
	(:init
		...
		(tv-playing-channel linda-bedroom-tv the-discovery-channel)
		...
		(shelf-contains linda-bedroom-shelf fork level-5)
		(shelf-contains linda-bedroom-shelf bowl level-8)
		(table-contains mark-bedroom-table of-mice-and-men-book)
		(table-contains linda-bedroom-table apple)
		(shelf-contains mark-bedroom-shelf orange level-8)
		(sink-contains kitchen-sink knife)
		(shelf-contains living-room-shelf purple-pen level-3)
		(shelf-contains mark-bedroom-shelf black-pen level-6)
		(shelf-contains living-room-shelf tom-sawyer-book level-3)
		(shelf-contains mark-bedroom-shelf plate level-1)
		(shelf-contains living-room-shelf spoon level-1)
		(shelf-contains mark-bedroom-shelf lord-of-the-rings-book level-7)
