(define (problem simulation-a)
	...
	(:init
		...
		(shelf-contains linda-bedroom-shelf of-mice-and-men-book level-6)
		(shelf-contains linda-bedroom-shelf apple level-10)
		(table-contains linda-bedroom-table orange)
		(shelf-contains mark-bedroom-shelf knife level-2)
		(table-contains mark-bedroom-table purple-pen)
		...
		(shelf-contains living-room-shelf lord-of-the-rings-book level-1)
		(table-contains living-room-table blue-pen)
	)
)
