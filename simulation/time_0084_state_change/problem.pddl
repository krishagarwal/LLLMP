(define (problem simulation-a)
	...
	(:init
		...
		(tv-playing-channel jane-bedroom-tv fox-news)
		...
		(tv-playing-channel john-bedroom-tv fox-news)
		...
		(shelf-contains jane-bedroom-shelf red-pen level-1)
		(table-contains jane-bedroom-table spoon)
		(table-contains john-bedroom-table white-pen)
		(table-contains jane-bedroom-table orange)
		(shelf-contains john-bedroom-shelf fahrenheit-451-book level-5)
		(shelf-contains jane-bedroom-shelf apple level-3)
		(table-contains john-bedroom-table purple-pen)
		(shelf-contains jane-bedroom-shelf alchemist-book level-2)
		(table-contains jane-bedroom-table bowl)
		(shelf-contains john-bedroom-shelf of-mice-and-men-book level-3)
