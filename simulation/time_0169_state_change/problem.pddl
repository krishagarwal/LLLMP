(define (problem simulation-a)
	...
	(:init
		...
		(tv-playing-channel living-room-tv the-discovery-channel)
		...
		(shelf-contains living-room-shelf red-pen level-6)
		(shelf-contains john-bedroom-shelf spoon level-5)
		(table-contains john-bedroom-table white-pen)
		(table-contains jane-bedroom-table orange)
		(shelf-contains john-bedroom-shelf fahrenheit-451-book level-1)
