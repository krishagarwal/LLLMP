(define (problem simulation-a)
	...
	(:init
		...
		(shelf-contains jane-bedroom-shelf white-pen level-1)
		(table-contains john-bedroom-table orange)
		(shelf-contains jane-bedroom-shelf fahrenheit-451-book level-3)
		...
		(table-contains jane-bedroom-table plate)
