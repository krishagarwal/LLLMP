(define (problem simulation-a)
	...
	(:init
		...
		(tv-playing-channel jane-bedroom-tv espn)
		...
		(table-contains living-room-table red-pen)
		(shelf-contains living-room-shelf spoon level-5)
		(shelf-contains jane-bedroom-shelf white-pen level-6)
		(table-contains jane-bedroom-table orange)
		(table-contains john-bedroom-table fahrenheit-451-book)
		(fridge-contains kitchen-fridge apple)
		(shelf-contains living-room-shelf purple-pen level-3)
		(shelf-contains john-bedroom-shelf alchemist-book level-1)
