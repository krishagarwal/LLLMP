(define (problem simulation-a)
	...
	(:init
		...
		(shelf-contains jane-bedroom-shelf red-pen level-4)
		(table-contains john-bedroom-table spoon)
		(table-contains jane-bedroom-table white-pen)
		...
		(shelf-contains john-bedroom-shelf plate level-4)
